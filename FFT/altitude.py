...
if __name__ == "__main__":
    ...
    location = (-8.461475,119.8767999) #Labuan Bajo
    
    when = (2018, 4, 24, 5, 6, 19, 8) #(2018, 4, 24, 3, 51, 37, 7)
  ...
  # When:  (2018, 5, 11, 4, 19, 0, 8)
  # year, month, day, hour, minute, second, timezone
  # Where:  (40.602778, -104.741667)
  # Azimuth:  121.38
  # Elevation:  61.91
  # main code from John Clark Claig : https://levelup.gitconnected.com/python-sun-position-for-solar-energy-and-research-7a4ead801777
